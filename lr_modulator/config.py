...
class ExperimentConfig:
    ...
    # Paths
    is_kaggle: bool = field(default_factory=lambda: os.path.exists("/kaggle") and os.path.exists("/kaggle/working"))
    ...
    scratch_methods: List[str] = field(
        default_factory=lambda: ["cosine", "onecycle", "ours_cosine", "ours_onecycle"]
    )
    ...
    def __post_init__(self) -> None:
        ...
        self.save_dir = "/kaggle/working/results_lr_modulator" if self.is_kaggle else "./results_lr_modulator"
